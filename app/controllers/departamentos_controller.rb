class DepartamentosController < ApplicationController
  ...
  before_action :autorizacion, except: [:index]
  ...
  def new
    @departamento = current_user.departamentos.new
  end
  ...
  def create
    @departamento = current_user.departamentos.new(departamento_params)
  ...
  private
    ...
    def departamento_params
      params.require(:departamento).permit(:nombre, :user_id, :supervisor)
    end

    def autorizacion
      unless current_user.admin?
         redirect_to user_path(current_user), alert: 'No tienes permiso para ver los departamentos' and return
      end
    end
end
